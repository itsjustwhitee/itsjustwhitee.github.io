const bentoData = [
    ...
    },
    {
        ...
        desc: "Something I do not use anymore is here...",
...
function getIcon(link) {
    if (!link) return "";
    if (link.includes("instagram.com")) return '<i class="fa-brands fa-instagram brand-instagram"></i>';
    if (link.includes("telegram.me") || link.includes("t.me")) return '<i class="fa-brands fa-telegram brand-telegram"></i>';
    if (link.includes("paypal.me")) return '<i class="fa-brands fa-paypal brand-paypal"></i>';
    if (link.includes("amazon.")) return '<i class="fa-brands fa-amazon brand-amazon"></i>';
    if (link.includes("github.com")) return '<i class="fa-brands fa-github brand-github"></i>';
    if (link.includes("notion.site")) return '<i class="fa-solid fa-note-sticky brand-notion"></i>';
    if (link.includes("vinted")) return '<i class="fa-solid fa-shirt brand-vinted"></i>';
    if (link.includes("ebay")) return '<i class="fa-brands fa-ebay brand-ebay"></i>';
    if (link.includes("subito")) return '<i class="fa-solid fa-cart-shopping brand-subito"></i>';
