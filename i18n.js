...
(function () {
    ...
    const T = {
        en: {
            ...
            'section.uni.title':       'Uni',
            'resource.notion.title':   'Notes & Resources',
            'resource.notion.desc':    'A running Notion page with notes, references, and other things worth keeping.',
            'resource.notion.dl_visit': 'Open Notion',
            'section.printing.title':  '3D Printing',
            'resource.nexprint.title': 'Nexprint Profile',
            'resource.nexprint.desc':  '3D models I create and print using my CC2.',
            'resource.nexprint.dl_visit': 'View Profile',
            'section.electronics.title': 'Electronics',
            'resource.fritzing.title': 'Fritzing',
            'resource.fritzing.desc':  'Open-source app I use to sketch breadboard circuits and PCBs.',
            'resource.fritzing.dl_visit': 'Get Fritzing',
            'section.security.title':  'Security',
            'resource.bitwarden.title': 'Bitwarden',
            'resource.bitwarden.desc':  'The password/TOTP/Secret manager I use to keep everything locked down. Has a solid free tier too.',
            'resource.bitwarden.dl_visit': 'Get Bitwarden',
        ...
        it: {
            ...
            // ── Resources page ──────────────────────────────────────────────────
            'resources.page_label': '// resources',
            'resources.title':      '<span>Risorse</span>',
            'resources.page_sub':   'Tool, articoli e altre cose che trovo utili da condividere, creati da me o da altri!',
            'section.appearance.title': 'Look',
            'resource.deskmat.title': 'BluePrint Wallpaper',
            'resource.deskmat.desc':  'Sfondo desktop in stile blueprint, in due varianti.',
            'resource.deskmat.dl_normal': 'Normale',
            'resource.deskmat.dl_blank':  'Blank',
            'section.uni.title':       'Uni',
            'resource.notion.title':   'Appunti & Risorse',
            'resource.notion.desc':    'Una pagina Notion in continuo aggiornamento con appunti, riferimenti e altre cose utili.',
            'resource.notion.dl_visit': 'Apri Notion',
            'section.printing.title':  'Stampa 3D',
            'resource.nexprint.title': 'Profilo Nexprint',
            'resource.nexprint.desc':  'Modelli 3D che creo e stampo con la mia CC2.',
            'resource.nexprint.dl_visit': 'Vedi profilo',
            'section.electronics.title': 'Elettronica',
            'resource.fritzing.title': 'Fritzing',
            'resource.fritzing.desc':  'App open-source che uso per progettare circuiti su breadboard e PCB.',
            'resource.fritzing.dl_visit': 'Scarica Fritzing',
            'section.security.title':  'Sicurezza',
            'resource.bitwarden.title': 'Bitwarden',
            'resource.bitwarden.desc':  'Il password/TOTP/Secret manager che uso per tenere tutto al sicuro. Ha anche un buon piano gratuito.',
            'resource.bitwarden.dl_visit': 'Scopri Bitwarden',
